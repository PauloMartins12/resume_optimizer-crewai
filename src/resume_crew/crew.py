...
class ResumeCrew():
    ...
    def __init__(self) -> None:
        ...
        self.resume_pdf = PDFKnowledgeSource(file_paths="CV Paulo Martins-2025_03-AI.pdf")

    @agent
    def resume_analyzer(self) -> Agent:
        return Agent(
            config=self.agents_config['resume_analyzer'], # type: ignore
            verbose=True,
            llm=LLM("o1"),
    ...
    def job_analyzer(self) -> Agent:
        return Agent(
            config=self.agents_config['job_analyzer'], # type: ignore
            verbose=True,
